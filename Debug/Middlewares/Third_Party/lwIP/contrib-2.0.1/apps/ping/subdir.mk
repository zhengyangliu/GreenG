...
C_SRCS += \
../Middlewares/Third_Party/lwIP/contrib-2.0.1/apps/ping/ping.c 

OBJS += \
./Middlewares/Third_Party/lwIP/contrib-2.0.1/apps/ping/ping.o 

C_DEPS += \
./Middlewares/Third_Party/lwIP/contrib-2.0.1/apps/ping/ping.d 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/Third_Party/lwIP/contrib-2.0.1/apps/ping/%.o: ../Middlewares/Third_Party/lwIP/contrib-2.0.1/apps/ping/%.c
	@echo 'Building file: $<'
