...
C_SRCS += \
../Middlewares/Third_Party/lwIP/contrib-2.0.1/apps/chargen/chargen.c 

OBJS += \
./Middlewares/Third_Party/lwIP/contrib-2.0.1/apps/chargen/chargen.o 

C_DEPS += \
./Middlewares/Third_Party/lwIP/contrib-2.0.1/apps/chargen/chargen.d 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/Third_Party/lwIP/contrib-2.0.1/apps/chargen/%.o: ../Middlewares/Third_Party/lwIP/contrib-2.0.1/apps/chargen/%.c
	@echo 'Building file: $<'
